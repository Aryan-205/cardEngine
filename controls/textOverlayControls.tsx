  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <h3 className="font-semibold text-sm text-black">Text Overlays</h3>
        <Button
          variant="outline"
          size="sm"
      ...
      {selectedOverlay ? (
        <div className="space-y-5 border-t pt-5">
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold text-black">Font Weight</p> 
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold text-black">Text Orientation</p>
              <Select
                value={selectedOverlay.orientation}
                onValueChange={(value) =>
                  handleUpdateOrientation(value as "horizontal" | "vertical")
                }
              >
                <SelectTrigger className="w-full h-11 rounded-xl border-border focus:border-primary focus:ring-2 focus:ring-ring">
            ...
            <div className="flex items-center justify-between gap-3 p-3 rounded-xl bg-muted border border-border">
              <span className="text-sm font-medium text-black whitespace-nowrap">
                Opacity
              </span>
              <div className="flex-1 flex items-center gap-3">
            ...
            <div className="space-y-4 border-t pt-5">
              ...
              {selectedOverlay.textShadow.enabled && (
                <div className="space-y-4">
                  {/* Shadow Color */}
                  <div className="space-y-2">
                    <p className="text-sm font-semibold text-black">Shadow Color</p>
            ...
            <div className="space-y-4">
              <p className="text-sm font-semibold text-black">Position</p>
              {/* X position */}
